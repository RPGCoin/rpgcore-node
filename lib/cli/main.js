...
var rpgcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = rpgcorenode.version;
  var create = rpgcorenode.scaffold.create;
  var add = rpgcorenode.scaffold.add;
  var start = rpgcorenode.scaffold.start;
  var remove = rpgcorenode.scaffold.remove;
  var callMethod = rpgcorenode.scaffold.callMethod;
  var findConfig = rpgcorenode.scaffold.findConfig;
  var defaultConfig = rpgcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the RPGcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `rpgcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ rpgcore-node add wallet-service');
      console.log('    $ rpgcore-node add insight-api-rpg');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ rpgcore-node remove wallet-service');
      console.log('    $ rpgcore-node remove insight-api-rpg');
      console.log();
    });
