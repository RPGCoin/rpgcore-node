...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    rpgd.spawn.datadir.should.equal(home + '/.rpg');
    rpgd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/rpgd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.rpgd.spawn.datadir.should.equal('./data2');
  });
});
