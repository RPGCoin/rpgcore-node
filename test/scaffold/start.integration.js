...
var RPGcoinService = require('../../lib/services/rpgd');
...
describe('#start', function() {
  ...
  describe('will dynamically create a node from a configuration', function() {
    ...
    it('require each rpgcore-node service with default config', function(done) {
      var node;
    ...
    it('require each rpgcore-node service with explicit config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'rpgd',
