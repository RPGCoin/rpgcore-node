...
module.exports.services.RPGcoin = require('./lib/services/rpgd');
...
module.exports.cli.rpgcore = require('./lib/cli/rpgcore');
module.exports.cli.rpgcored = require('./lib/cli/rpgcored');

module.exports.lib = require('rpgcore-lib');
